...
**Nursery location (latitude, longitude):**  
`r c(params[["HLat"]], params[["HLon"]])`  
...
# **Summary**
Seaweed incorporate nutrients into their tissues as they grow. At harvest, these nutrients are permanently removed from the coastal environment, providing a benefit to water quality in the form of excess nutrient reduction. The harvest of `r params$table[[6]]` `r params[["Units"]]` of seaweed is expected to result in the removal of a total of `r params$table[[3]]` pounds (lbs) of nitrogen from coastal Maine waters during the harvest period.
